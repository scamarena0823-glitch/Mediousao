/* MEDIOUSAO UI v2026-09-13-12 */
(function(){
  function inject(){
    if(document.getElementById('mediousao-ui-v12')) return;
    const style=document.createElement('style');
    style.id='mediousao-ui-v12';
    style.textContent=`
    ...
    bottom.innerHTML=`
      <button data-go="home" class="active">
        <svg class="home-icon" viewBox="0 0 24 24"><path d="M3 10.8 12 3l9 7.8v9.2a1 1 0 0 1-1 1h-5v-6H9v6H4a1 1 0 0 1-1-1z"/></svg>
        <span class="nav-label">Casa</span>
      </button>
      <button data-go="upcoming">
        <svg viewBox="0 0 24 24"><circle cx="12" cy="12" r="9"/><path d="M12 7v5l3 2"/></svg>
        <span class="nav-label">Próximamente</span>
      </button>
      <button data-go="reserve">
        <svg viewBox="0 0 24 24"><rect x="3.5" y="5" width="17" height="16" rx="2"/><path d="M7 3v4M17 3v4M3.5 9h17M8 13h2M14 13h2M8 17h2M14 17h2"/></svg>
    ...
    bottom.querySelectorAll('button').forEach(btn=>btn.addEventListener('click',function(){
